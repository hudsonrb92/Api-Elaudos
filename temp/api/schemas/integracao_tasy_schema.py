...
class IntegracaoTasySchema(ma.SQLAlchemyAutoSchema):
    ...
    nr_atendimento = fields.Integer(required=False, default=None, allow_none=True)
    nr_prescricao = fields.Integer(required=False, default=None, allow_none=True)
    nr_sequencia = fields.Integer(required=False, default=None, allow_none=True)
    ...
    dt_nascimento = fields.Date(required=False, default=None, allow_none=True)
    ...
    nr_prontuario = fields.Integer(required=False, default=None, allow_none=True)
    ...
    nm_social = fields.String(required=False, default=None, allow_none=True)
