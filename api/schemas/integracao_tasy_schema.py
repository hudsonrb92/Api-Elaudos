...
class IntegracaoTasySchema(ma.SQLAlchemyAutoSchema):
    ...
    nm_sobrenome_pai = fields.String(required=False, default=None, alow_none=True)
    nm_sobrenome_mae = fields.String(required=False, default=None, alow_none=True)
    nm_primeiro_nome = fields.String(required=False, default=None, alow_none=True)
